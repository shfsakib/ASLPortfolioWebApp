                ...
                <div class="box-body col-12">
                    ...
                    <div class="row">
                        <div class="col-md-12 table-responsive">
                            <asp:GridView ID="gridRole" Width="100%" class="table table-hover table-bordered table-striped" OnPageIndexChanging="gridRole_OnPageIndexChanging" AutoGenerateColumns="False" ShowHeader="True" ShowHeaderWhenEmpty="True" EmptyDataText="No Role Found" AllowPaging="True" PageSize="30" runat="server">
                                <Columns>

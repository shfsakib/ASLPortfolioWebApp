<%@ Page Title="" Language="C#" MasterPageFile="~/admin/root.Master" AutoEventWireup="true" CodeBehind="portfolio-details.aspx.cs" Inherits="ASLPortfolioWebApp.admin.portfolio_details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-center p-4">
                            ...
                            <div class="col-md-12 p-4">
                                <asp:LinkButton ID="lnkPrev" class="btn btn-default" OnClick="lnkPrev_OnClick" runat="server"><i class="fas fa-chevron-left"></i></asp:LinkButton>
                                <asp:LinkButton ID="lnkNext" class="btn btn-default" OnClick="lnkNext_OnClick" runat="server"><i class="fas fa-chevron-right"></i></asp:LinkButton>
                            </div>
                        </div>
                        <div class="col-md-1"></div>
                    </div>
        ...
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="lnkPrev" />
